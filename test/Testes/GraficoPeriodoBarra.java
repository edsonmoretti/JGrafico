...
import br.com.edsonmoretti.jgrafico.JGraficoPeriodoBarra;
 ...
 * @author Edson
 */
public class GraficoPeriodoBarra {
    
    public static void main(String[] args) {
        JGraficoPeriodoBarra demo = new JGraficoPeriodoBarra("Edson Moretti - www.edsonmoretti.com.br");
